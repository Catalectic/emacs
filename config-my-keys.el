...
(define-key my-keys-minor-mode-map (kbd "C-p") 'other-frame)
(define-key my-keys-minor-mode-map (kbd "C-n")
  '(lambda () (interactive)
    (other-frame -1)))
(define-key my-keys-minor-mode-map (kbd "C-z") 'switch-frame)
...
(define-key my-keys-minor-mode-map (kbd "C-c <DEL>") 'helm-resume)
